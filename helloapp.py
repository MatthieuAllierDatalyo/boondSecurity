...
BOONDMANAGER_APP_KEY = "app_key"  # TO CHANGE
...
def current_user():
    ...
    signed_request = request.params.get("signedRequest")
    ...
    jwt = get_jwt(
        user_token=settings.get("app_token"), client_key=BOONDMANAGER_APP_KEY, client_token=payload.get("client_token")
    )
    print(jwt)
